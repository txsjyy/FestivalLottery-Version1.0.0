globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/ufo/dist/index.mjs';
import destr from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/He Tianxing/Documents/truelot/lottery-combined/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\He Tianxing\\Documents\\truelot\\lottery-combined","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\He Tianxing\\Documents\\truelot\\lottery-combined\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\He Tianxing\\Documents\\truelot\\lottery-combined\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\He Tianxing\\Documents\\truelot\\lottery-combined\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_YwmUOf = () => Promise.resolve().then(function () { return entries$1; });
const _lazy_snvnGD = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/He%20Tianxing/Documents/truelot/lottery-combined/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
